...
<div class="container">
    ...
    <div class="cv-section">
        ...
        <div class="cv-item">
            ...
            <p style="margin-top: 1rem;"><strong>Secondary Areas:</strong></p>
            <ul style="margin-left: 1.5rem;">
...
.cv-item div[style*="grid"] h4 {
    color: var(--primary-color);
    margin-bottom: 0.5rem;
}

.cv-item div[style*="grid"] p {
    margin-bottom: 0.25rem;
    line-height: 1.4;
}

.cv-item div[style*="grid"] em {
    color: var(--text-light);
    font-style: italic;
}

/* Styling for technical skills lists */
.cv-item ul {
    margin-bottom: 1rem;
}
